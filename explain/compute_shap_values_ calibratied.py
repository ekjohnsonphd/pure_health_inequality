...
death_idx=np.random.choice(X_deaths.index, size=n_deaths, replace=False)
survivor_idx = np.random.choice(X_survivors.index, size=n_survivors, replace=False)
