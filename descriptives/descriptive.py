...
SEX         = "Male"   # "Male" or "Female" or None (keep both)
OUTCOME     = "early_death"
...
def risk_ratio_from_counts(a, b, c, d):
    # a = dead among exposed,   b = alive among exposed
    # c = dead among unexposed, d = alive among unexposed
